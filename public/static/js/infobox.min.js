...
(function () {
  ...
  (function () {
    ...
    baidu.dom._NAME_ATTRS = (function () {
      var result = { cellpadding: 'cellPadding', cellspacing: 'cellSpacing', colspan: 'colSpan', rowspan: 'rowSpan', valign: 'vAlign', usemap: 'useMap', frameborder: 'frameBorder' };
  ...
  var InfoBox = (BMapGLLib.InfoBox = function (map, content, opts) {
    ...
    this._opts.closeIconClickType = opts.closeIconClickType || 0;
  ...
  InfoBox.prototype.open = function (anchor) {
    ...
    if (anchor instanceof BMapGL.Point) {
      ...
      if (anchor instanceof BMapGL.Marker) {
        if (this._marker) {
          this._removeMarkerEvt();
        }
