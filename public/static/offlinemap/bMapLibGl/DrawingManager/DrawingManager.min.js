...
(function () {
  ...
  // 计算右下角坐标点
  var getLeftTopPoint = function (path) {
    var left = Infinity; // 初始化为正无穷，表示最左边
    var top = -Infinity; // 初始化为负无穷，表示最上边
    var leftTopPoint = null;
  ...
  DrawingManager.prototype._calculate = function (overlay, point) {
    // if (labelOverlay) {
    //   this._map.removeOverlay(labelOverlay);
    // }
    var result = {
      data: 0, // 计算出来的长度或面积
    ...
    if (this._enableCalculate && BMapGLLib.GeoUtils) {
       ...
       */
      // if (point.length) {
      //   point = getLeftTopPoint(point);
      // } else {
      //   point = new BMapGL.Point(point.lng, point.lat - 0.01);
      // }
